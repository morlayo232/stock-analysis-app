...
# app.py 상단 임포트에 추가
from evaluate_stock import evaluate_stock_extended_1, 
evaluate_stock_extended_2, 
evaluate_stock_extended_3, 
evaluate_stock_extended_4, 
evaluate_stock_extended_5, 
evaluate_stock_extended_6
