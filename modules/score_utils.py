...
def finalize_scores(df, style="aggressive"):
    """
    df 에는 이미 'PER','PBR','EPS','BPS','배당률','거래량','거래량평균20','고가','저가','현재가' 컬럼이 있어야 합니다.
    ...
    weights = {
        ...
        "stable":     [-0.2, -0.3,  0.1,  0.2, 0.10, 0.1],
        "dividend":   [-0.15,-0.1,  0.05, 0.05,0.40, 0.1]
    }[style]
